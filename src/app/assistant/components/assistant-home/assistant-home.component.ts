...
export class AssistantHomeComponent implements OnInit, OnDestroy {
  ...
  haveObservatory(): boolean {
    return !!this.observatoryObj;
  }

  invalidObservatory(): boolean {
    return this.observatoryObj.latitude === 1 || this.observatoryObj.longitude === 1;
  }
  ...
  invalidTarget(): boolean {
    return this.targetObj.rightAscension === 1 || this.targetObj.declination === 1;
  }
